...
#define METATABLE "boolarray.meta"
...
static const struct luaL_Reg boolarray_lib[] = {
													{"new", newarray},
													{NULL, NULL}
												};
static const struct luaL_Reg boolarray_lib_member_fun[] = {
													{"set", setarray},
													{"get", getarray},
													{"size", getarraysize},
													{NULL, NULL}
